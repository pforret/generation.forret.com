...
<body>
@include("landwind.header")

@include('landwind.hero')

@include('landwind.logos')

@include('landwind.features')

@include('landwind.trusted')

@include('landwind.quote')

@include('landwind.pricing')

@include('landwind.faq')

@include('landwind.trial')

@include('landwind.footer')
